      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row justify-between items-end mb-20 gap-8">
          <div className="max-w-2xl">
            <span className="text-[#F3C623] font-black tracking-[0.5em] uppercase text-[10px] mb-4 block">Sistem Manajemen Pengetahuan</span>
          ...
          {categories.map(cat => (
            <button 
              ...
              className={`px-8 py-4 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all ${
                activeCategory === cat ? 'bg-[#0A0F1E] text-white shadow-xl' : 'bg-white text-black hover:bg-gray-100'
              }`}
            >
              {cat}
            </button>
            ...
            <div key={i} className="group bg-white p-10 rounded-[48px] border border-gray-100 hover:shadow-2xl transition-all duration-700 relative overflow-hidden">
               ...
               <div className="flex items-center justify-between pt-8 border-t border-gray-50">
                  <div className="flex flex-col">
                    ...
                    <span className="text-[#0A0F1E] font-black text-xs">DOKUMEN PDF</span>
                  </div>
