                    ...
                    {assignments.map((item, i) => (
                      <div key={i} className="flex items-center justify-between p-4 bg-gray-50 rounded-2xl group hover:bg-[#0A0F1E] transition-all">
                        <div>
                          ...
                          <p className="text-[10px] text-gray-600 group-hover:text-white/40">{item.task}</p>
                        </div>
               ...
               <div className="flex flex-col md:flex-row items-center justify-between gap-10">
                 <div className="flex items-center space-x-8">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-gray-600 font-bold uppercase tracking-widest mt-1">Siswa Teraktif Bulan Ini</p>
                    </div>
                 </div>
                 ...
                 <div className="flex items-center space-x-6">
                    ...
                    <button className="flex items-center space-x-3 text-gray-600 hover:text-[#0A0F1E] transition-colors">
