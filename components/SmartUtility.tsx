    ...
    <section className="py-48 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row justify-between items-end mb-32 gap-12">
          ...
          <p className="text-gray-600 text-xl font-light leading-relaxed max-w-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {tools.map((tool, i) => (
            <div key={i} className="group bg-[#F8F9FB] p-12 rounded-[60px] hover:bg-[#F3C623] transition-all duration-700 cursor-pointer">
              ...
              <p className="text-gray-600 group-hover:text-[#0A0F1E]/60 text-sm font-light mb-12">{tool.desc}</p>
